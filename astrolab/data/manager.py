...
class DataManager(tlc.SingletonConfigurable,AstroSingleton):
    ...
    def prepare_inputs( self, input_file_id ):
        np_embedding = self.getInputFileData( input_file_id, self.subsample )
    ...
    def getCreationPanel(self) -> ip.HBox:
        ...
        creationPanel: ip.HBox = ip.HBox( [load], layout=ip.Layout( width="100%", height="100%" ), border= '2px solid firebrick' )
